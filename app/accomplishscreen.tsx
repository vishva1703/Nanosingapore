...
const DIET_OPTIONS: ReadonlyArray<{
    ...
    { value: 'eat_and_live_healthier', label: 'Eat and live healthier', type: 'fa', icon: 'bowl-food' },
    { value: 'boost_energy_mood', label: 'Boost my energy and mood', type: 'ion', icon: 'flash' },
    { value: 'stay_motivated', label: 'Stay motivated', type: 'mci', icon: 'arm-flex' }, // 💪 bicep icon
            ...
            <View style={styles.wrapper}>
                ...
                <ScrollView contentContainerStyle={styles.container} showsVerticalScrollIndicator={false}>
                    <View style={styles.section}>
                        <Text style={styles.sectionLabel}>What would you like to accomplish?</Text>
                ...
                <View style={styles.bottomContainer}>
                    <TouchableOpacity
                        ...
                        onPress={() => router.push('/potentialscreen')}
                    >
